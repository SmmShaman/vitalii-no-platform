...
const PATTERNS: [RegExp, SceneEffectType][] = [
  ...
  [/matrix|digital\s*rain|code\s*rain|hacking|cyber/i, "matrixRain"],
  [/scrolling\s*photos?|photo\s*stream|image\s*feed|parallax\s*photos?/i, "photoScrollColumns"],
  [/circuit|data\s*stream|digital.*pattern/i, "circuitBoard"],
