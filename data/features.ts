...
export const projects: ProjectInfo[] = [
  {
    ...
    description: {
      en: 'AI-powered multilingual content platform',
      no: 'AI-drevet flerspråklig innholdsplattform',
      ua: 'AI-платформа багатомовного контенту',
    },
  ...
  },
  {
    ...
    description: {
      en: 'Intelligent job hunting automation platform',
      no: 'Intelligent automatiseringsplattform for jobbsøk',
      ua: 'AI-платформа автоматизації пошуку роботи',
    },
    badge: 'J',
